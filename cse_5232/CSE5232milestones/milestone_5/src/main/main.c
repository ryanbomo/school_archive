...
main (int argc, char **argv)
{
  ...
  int time_out =20;// time out int in seconds, 20 set to default
   ...
   * -D sets length of inactivity time before drop from peers, default is 20 seconds for assignment, this is very quick in practice
